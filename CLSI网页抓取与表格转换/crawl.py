...
title = browser.find_element(By.XPATH, '//*[@id="CLSI M100 ED33:2023 TABLE 1A"]/h1/b/span')
...
data['抗生素'].append(None)
data['抗生素上标'].append(None)
data['抗生素说明'].append(None)
data['分级'].append(None)
data['分级说明'].append(None)
data['尿检'].append(None)
